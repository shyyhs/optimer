# OptiMer: Optimal Distribution Vector Merging for Continued Pre-Training

**Authors:** Haiyue Song, Masao Utiyama (NICT, Japan)
...
Update (2026/06): The model and code release are approved. 
The code is now under NICT's official github, [link](https://github.com/nict-astrec-att/optimer).
